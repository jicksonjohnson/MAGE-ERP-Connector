 ...
 * @package HelloMage\ErpConnector\Observer\OrderPlaceAfter
 */
class OrderPlaceAfter implements \Magento\Framework\Event\ObserverInterface
{
    ...
    /**
     * Observer for placing the order after event.
     *
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $orderId = $order->getId();
        $event = 'OrderPlaceAfter';

        // instant call to ERP system is replaced by internal record create
        // $this->_erpAuthenticator->callErpOrderCreate($orderId, $event);
