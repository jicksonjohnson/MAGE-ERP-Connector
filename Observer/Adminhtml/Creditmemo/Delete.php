...
namespace HelloMage\ErpConnector\Observer\Adminhtml\Creditmemo;
...
/**
 * Class Delete
 * @package HelloMage\ErpConnector\Observer\Adminhtml\Creditmemo\Delete
 */
class Delete implements ObserverInterface
{
    ...
    /**
     * Observer for credit memo delete event in adminhtml.
     *
    ...
    public function execute(Observer $observer)
    {
        try {
            ...
            $invoiceId = null;
            $shipmentId = null;
            $creditMemoId = $info->getCreditmemoId();
            $event = 'CreditMemoDelete';
            ...
            if (isset($orderId) && $orderId > 0) {
                try {
                    ...
                    $record->addData([
                        ...
                        "type" => 'order',
                        "event" => $event,
                        "note" => 'Creditmemo ID ' . $creditMemoId,
